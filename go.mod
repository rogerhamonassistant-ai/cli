...
// BigSurBackport pins the newest known dependency set that still builds with
// Go 1.24.x on darwin/amd64. Keep this block small, intentional, and easy to
// reconcile against upstream updates.
replace (
	charm.land/bubbles/v2 => charm.land/bubbles/v2 v2.0.0
	charm.land/huh/v2 => charm.land/huh/v2 v2.0.0
	charm.land/lipgloss/v2 => charm.land/lipgloss/v2 v2.0.0
	github.com/cli/go-gh/v2 => github.com/cli/go-gh/v2 v2.12.2
	github.com/google/go-containerregistry => github.com/google/go-containerregistry v0.20.7
	github.com/sigstore/rekor => github.com/sigstore/rekor v1.4.3
	github.com/sigstore/sigstore => github.com/sigstore/sigstore v1.9.5
	github.com/sigstore/sigstore-go => github.com/sigstore/sigstore-go v1.1.3
	github.com/sigstore/timestamp-authority/v2 => github.com/sigstore/timestamp-authority/v2 v2.0.1
